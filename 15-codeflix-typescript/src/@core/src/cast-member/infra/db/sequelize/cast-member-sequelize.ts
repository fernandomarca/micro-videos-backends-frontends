import { CastMemberType, Types } from "cast-member/domain/value-objects/cast-member-type.vo";
import { Column, DataType, Model, PrimaryKey, Table } from "sequelize-typescript";
import {
  CastMemberRepository as CastMemberRepositoryContract
} from "cast-member/domain/repository/cast-member.repository";
import {
...
export namespace CastMemberSequelize {
  ...
  export class CastMemberRepository implements CastMemberRepositoryContract.Repository {
    ...
    constructor(
      private castMemberModel: typeof CastMemberModel
    ) { }
