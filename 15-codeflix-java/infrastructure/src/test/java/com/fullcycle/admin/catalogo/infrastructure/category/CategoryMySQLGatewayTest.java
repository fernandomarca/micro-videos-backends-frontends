...
class CategoryMySQLGatewayTest {
  ...
  @Test
  void givenAPrePersistedCategoryIdNotStored_whenCallsFindById_shouldReturnEmpty() {
  ...
  @Test
  public void givenPrePersistedCategoriesAndDocsAsTerms_whenCallsFindAllAndTermsMatchCategoryName_shouldReturnPaginated() {
    final var expectedPage = 0;
    final var expectedPerPage = 1;
