...
public interface MockDsl {
   ...
   * Cast Member
   */
  // default ResultActions deleteACastMember(final CastMemberID anId) throws
  // Exception {
  // return this.delete("/cast_members/", anId);
  // }

  // default CastMemberID givenACastMember(final String aName, final
  // CastMemberType aType) throws Exception {
  ...
  // default ResultActions givenACastMemberResult(final String aName, final
  // CastMemberType aType) throws Exception {
  // final var aRequestBody = new CreateCastMemberRequest(aName, aType);
  // return this.givenResult("/cast_members", aRequestBody);
  // }

  // default ResultActions listCastMembers(final int page, final int perPage)
  // throws Exception {
  ...
  // default CastMemberResponse retrieveACastMember(final CastMemberID anId)
  // throws Exception {
  // return this.retrieve("/cast_members/", anId, CastMemberResponse.class);
  // }

  // default ResultActions retrieveACastMemberResult(final CastMemberID anId)
  // throws Exception {
  // return this.retrieveResult("/cast_members/", anId);
  // }

  // default ResultActions updateACastMember(final CastMemberID anId, final String
  // aName, final CastMemberType aType)
  // throws Exception {
  // return this.update("/cast_members/", anId, new UpdateCastMemberRequest(aName,
  // aType));
  // }
  ...
  default CategoryID givenACategory(final String aName, final String aDescription, final boolean isActive)
      throws Exception {
  ...
  default ResultActions listCategories(final int page, final int perPage)
      throws Exception {
  ...
  // default GenreID givenAGenre(final String aName, final boolean isActive, final
  // List<CategoryID> categories)
  // throws Exception {
  // final var aRequestBody = new CreateGenreRequest(aName, mapTo(categories,
  // CategoryID::getValue), isActive);
  // final var actualId = this.given("/genres", aRequestBody);
  // return GenreID.from(actualId);
  // }

  // default ResultActions listGenres(final int page, final int perPage) throws
  // Exception {
  // return listGenres(page, perPage, "", "", "");
  // }

  // default ResultActions listGenres(final int page, final int perPage, final
  // String search) throws Exception {
  // return listGenres(page, perPage, search, "", "");
  // }

  // default ResultActions listGenres(final int page, final int perPage, final
  // String search, final String sort,
  // final String direction) throws Exception {
  ...
  // default ResultActions updateAGenre(final GenreID anId, final
  // UpdateGenreRequest aRequest) throws Exception {
  ...
  private ResultActions retrieveResult(final String url, final Identifier anId)
      throws Exception {
    final var aRequest = get(url + anId.getValue())
        // .with(ApiTest.ADMIN_JWT)
        .accept(MediaType.APPLICATION_JSON)
