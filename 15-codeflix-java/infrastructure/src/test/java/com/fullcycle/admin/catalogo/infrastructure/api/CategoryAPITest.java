...
public class CategoryAPITest {
  ...
  // @Test
  // public void givenAValidId_whenCallsGetCategory_shouldReturnCategory() throws
  // Exception {
  // // given
  // final var expectedName = "Filmes";
  // final var expectedDescription = "A categoria mais assistida";
  ...
  // @Test
  // public void
  // givenAValidCommand_whenCallsUpdateCategory_shouldReturnCategoryId() throws
  // Exception {
  // // given
  ...
  // final var aCommand = new UpdateCategoryRequest(expectedName,
  // expectedDescription, expectedIsActive);
  ...
  // @Test
  // public void givenAValidId_whenCallsDeleteCategory_shouldReturnNoContent()
  // throws Exception {
  // // given
  // final var expectedId = "123";
  ...
  // @Test
  // public void givenValidParams_whenCallsListCategories_shouldReturnCategories()
  // throws Exception {
  // // given
  ...
  // equalTo(aCategory.getDescription())))
  ...
  // equalTo(aCategory.getDeletedAt())));
